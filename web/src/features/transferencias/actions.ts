...
/**
 * Transfiere un cliente completo y todos sus créditos.
 */
export async function transferirClienteCompletoAction(formData: FormData): Promise<void> {
...
/**
 * Transfiere solo un crédito individual.
 */
export async function transferirCreditoIndividualAction(formData: FormData): Promise<void> {
  const user = await requireTransferenciasUser();
