  ...
  const profiles = [
    {
      ...
      imageSrc: process.env.LOGIN_PROFILE_DANIEL_IMAGE || "/login/daniel.jpg",
      initials: "D",
    },
    {
      key: "padre",
      ...
      imageSrc: process.env.LOGIN_PROFILE_PADRE_IMAGE || "/login/padre.jpg",
      initials: "P",
    },
    {
      key: "madre",
      ...
      imageSrc: process.env.LOGIN_PROFILE_MADRE_IMAGE || "/login/madre.jpg",
      initials: "M",
    },
  ];
